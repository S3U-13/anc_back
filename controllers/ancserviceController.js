...
exports.create = async (req, res) => {
  ...
  try {
    const {
      ...
      treatment_date_1_wife,
      treatment_date_2_wife,
      treatment_date_3_wife,
      anti_hiv_wife,
      bl_gr_wife,
      rh_wife,
      hct_wife,
      ...
      treatment_date_1_lab_2,
      treatment_date_2_lab_2,
      treatment_date_3_lab_2,
      hiv,
      bti_value_1_id,
      bti_value_2_id,
      bti_value_3_id,
      ...
      treatment_date_1_husband,
      treatment_date_2_husband,
      treatment_date_3_husband,
      anti_hiv_husband,
      bl_gr_husband,
      rh_husband,
      hct_husband,
    ...
    const ref_other = await db.RefOther.create({
      ref_other_detail,
    });
      ...
      await db.LabWifeResult.update(
        {
          ...
          treatment_date_1_wife: req.body.treatment_date_1_wife || null,
          treatment_date_2_wife: req.body.treatment_date_2_wife || null,
          treatment_date_3_wife: req.body.treatment_date_3_wife || null,
    ...
    await anc_service.wife_text_value.update(
      {
        ...
        am_reason_checked: req.body.am_reason_checked || "",
        am_reason_not_checked: req.body.am_reason_not_checked || "",
        am_reason_consult: req.body.am_reason_consult || "",
        td_num: req.body.td_num || "",
        td_last_date: req.body.td_last_date || null,
        td_forget_date: req.body.td_forget_date || "",
        influenza_reason: req.body.influenza_reason || "",
        ap_reason: req.body.ap_reason || "",
        tdap_reason: req.body.tdap_reason || "",
        influenza_date: req.body.influenza_date || null,
        ap_date: req.body.ap_date || null,
        tdap_date: req.body.tdap_date || null,
        ...
        vdrl_lab_2: req.body.vdrl_lab_2 ? parseInt(req.body.vdrl_lab_2) : null,
        ppr_lab_2: req.body.ppr_lab_2 || null,
        tpha_lab_2: req.body.tpha_lab_2 || null,
        treatment_detail_lab_2: req.body.treatment_detail_lab_2 || "",
        treatment_date_1_lab_2: req.body.treatment_date_1_lab_2 || null,
        treatment_date_2_lab_2: req.body.treatment_date_2_lab_2 || null,
        treatment_date_3_lab_2: req.body.treatment_date_3_lab_2 || null,
        ...
        birads_reason_left: req.body.birads_reason_left || "",
        birads_reason_right: req.body.birads_reason_right || "",
        birads_reason_both_sides: req.body.birads_reason_both_sides || "",
        iodine_reason: req.body.iodine_reason || "",
        iron_reason: req.body.iron_reason || "",
        folic_reason: req.body.folic_reason || "",
        amoxicillin_reason: req.body.amoxicillin_reason || "",
        utrogestan_reason: req.body.utrogestan_reason || "",
      },
      { transaction: t }
    );
      ...
      await db.LabHusbandResult.update(
        {
          ...
          treatment_date_1_husband: req.body.treatment_date_1_husband || null,
          treatment_date_2_husband: req.body.treatment_date_2_husband || null,
          treatment_date_3_husband: req.body.treatment_date_3_husband || null,
  ...
  try {
    ...
    const result = {
      service_info: {
        ...
        wife_job: service.AncNo?.wife_job || null,
        ...
        husband_job: service.AncNo?.husband_job || null,
