...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable("lab_wife_result", {
      ...
      vdrl_wife: { allowNull: true, type: Sequelize.STRING(30) },
    ...
    await queryInterface.createTable("lab_husband_result", {
      ...
      vdrl_husband: { allowNull: true, type: Sequelize.STRING(30) },
    ...
    await queryInterface.createTable("wife_text_value", {
      ...
      bti_1_date: { type: Sequelize.DATE, allowNull: false },
      bti_2_date: { type: Sequelize.DATE, allowNull: false },
