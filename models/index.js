...
db.LabWifeResult = require("./lab_wife_result");
...
db.BloodTestInterpretation.belongsTo(db.AllChoice, {
  foreignKey: "bti_value_2_id",
  as: "bti_value_2",
});
db.BloodTestInterpretation.belongsTo(db.AllChoice, {
  foreignKey: "bti_value_3_id",
  as: "bti_value_3",
});
db.BloodTestInterpretation.belongsTo(db.AllChoice, {
  foreignKey: "bti_value_4_id",
  as: "bti_value_4",
});
db.BloodTestInterpretation.belongsTo(db.AllChoice, {
...
db.Cbe.belongsTo(db.AllChoice, {
  foreignKey: "cbe_value_1_id",
  as: "cbe_value_1",
});
db.Cbe.belongsTo(db.AllChoice, {
  foreignKey: "cbe_value_2_id",
  as: "cbe_value_2",
});
db.Cbe.belongsTo(db.AllChoice, {
  foreignKey: "cbe_value_3_id",
  as: "cbe_value_3",
});
db.Cbe.belongsTo(db.AllChoice, {
...
db.RefOutChoice.belongsTo(db.AllChoice, {
  foreignKey: "receive_out_id",
  as: "receive_out",
});
db.WifeChoiceValue.belongsTo(db.RefInChoice, {
  foreignKey: "ref_in_choice_id",
  as: "ref_in_choice",
});
db.WifeChoiceValue.belongsTo(db.RefOutChoice, {
  foreignKey: "ref_out_choice_id",
  as: "ref_out_choice",
});
...
db.AncService.belongsTo(db.WifeTextValue, {
  foreignKey: "wife_text_value_id",
  as: "wife_text_value",
});
db.AncService.belongsTo(db.HusbandValue, {
  foreignKey: "husband_value_id",
  as: "husband_value",
});
